<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"F:\PhpStudy\PHPTutorial\WWW\caigou\public/../application/admin\view\purchase\add.html";i:1558003080;s:77:"F:\PhpStudy\PHPTutorial\WWW\caigou\application\admin\view\layout\default.html";i:1557482264;s:74:"F:\PhpStudy\PHPTutorial\WWW\caigou\application\admin\view\common\meta.html";i:1557482264;s:76:"F:\PhpStudy\PHPTutorial\WWW\caigou\application\admin\view\common\script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-qty" data-rule="required" class="form-control" name="row[qty]" type="number">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-product_image" data-rule="" class="form-product_image" size="50" name="row[product_image]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_sn" class="form-control" name="row[order_sn]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Create_at'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-create_at" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[create_at]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Delivery_at'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-delivery_at" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[delivery_at]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-in_system_at" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[in_system_at]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Product_sku'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_sku" class="form-control" name="row[product_sku]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('In_system_qty'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-in_system_qty" class="form-control" name="row[in_system_qty]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-out_system_at" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[out_system_at]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Out_system_qty'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-out_system_qty" class="form-control" name="row[out_system_qty]" type="number">
        </div>
    </div>
    <div class="form-group">
